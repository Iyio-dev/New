...
if (isset($_POST['delete_comment'])) {
    ...
    $verify_comment = $conn->prepare("SELECT * FROM `comments` WHERE comment = ?");
    $verify_comment->execute([$delete_id]);

    if ($verify_comment->rowCount() > 0) {
        $delete_comment = $conn->prepare("DELETE FROM `comments` WHERE comment = ?");
            ...
            ?>
                    <div class="box">
                        <div class="comment-content">
                            <p><?= $fetch_content['title']; ?></p><a href="view_content.php?get_id=<?= $fetch_content['id'] ?>" class="inline-btn">view content</a>
                        </div>
                        <div class="user">
                            <?php
                        ...
                        <form action="" method="post">
                            <input type="hidden" name="comment_id" value="<?= $fetch_comment['comment']; ?>">
