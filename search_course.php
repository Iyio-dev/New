...
<div class="box-container">
    ...
    if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
        ...
        $select_content = $conn->prepare("SELECT * FROM `content` WHERE title LIKE '%{$search_box}%' ORDER BY date DESC");
    ...
    ?>
        <div class="box">
            <div class="flex">
                ...
                <a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>" class="btn">view content</a>
...
<?php
    if(isset($_POST['search_box']) OR isset($_POST['search_btn'])){
        ...
        $select_playlist = $conn->prepare("SELECT * FROM `playlist` WHERE title LIKE '%{$search_box}%' ORDER BY date DESC");
...
<div class="box">
    ...
    <a href="playlist.php?get_id=<?= $playlist_id;?>" class="btn">view playlist</a>
</div>
