    ...
    if($select_content->rowCount() > 0){
        ...
        <p>content status</p>
            <select name="status" id="" class="box">
                <option value="active" selected><?= $fetch_content['status'];?></option>
            ...
            <textarea name="description" class="box" cols="30" placeholder="enter content description" maxlength="1000" rows="10" id=""><?= $fetch_content['description']; ?></textarea>
            <select name="playlist" class="box" id="">
            ...
            <p>update video</p>
            <video src="../uploaded_files/<?= $fetch_content['video']?>" class="media" autoplay></video>
            ...
            <div class="flex-btn">
                ...
                <input type="submit" value="delete content" name="delete-btn" class="delete-btn">
            </div>
    </form>
    <?php
        }
