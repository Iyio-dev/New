    ...
    <section class="crud-form">
        ...
        ?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p>update title</p>
                    <input type="text" class="box" name="title" maxlength="100" value="<?= $fetch_playlist['title']; ?>" placeholder="enter playlist title" required>
                    <p>update description</p>
                    <textarea name="description" class="box" cols="30" placeholder="enter playlist description" maxlength="1000" rows="10" id="" required><?= $fetch_playlist['description']; ?></textarea>
