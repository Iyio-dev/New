...
if (isset($_POST['submit'])) {
    ...
    $verify_content = $conn->prepare("SELECT * FROM `playlist` WHERE tutor_id = ? AND title = ? AND description = ?");
...
<body>
    ...
    <section class="crud-form">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <textarea name="description" class="box" cols="30" required placeholder="enter content description" maxlength="1000" rows="10" id=""></textarea>
            ...
            <p>content thumbnail <span>*</span></p>
            <input type="file" name="thumb" class="box" required accept="image/*">
            <p>select video <span>*</span></p>
            <input type="file" name="video" class="box" required accept="video/*">
