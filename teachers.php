...
<body>
    ...
    <section class="teachers">
        ...
        <?php
                ...
                echo '<p class="empty">no tutor found</p>';
            }
        ?>
...
<body>
    ...
    <section class="teachers">
        ...
        <form action="" class="search-tutor" method="post">
        ...
        <div class="box-container">
            ...
            <div class="box offer">
                ...
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsa ut vero a</p>
