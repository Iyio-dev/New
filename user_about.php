...
<body>
    ...
    <section class="who-we-are">
        ...
        <div class="details">
            <img src="images/ruach_academy_logo.png" alt="">
            <p><span>"A</span> pex Tutors is an online learning platform offering high-quality courses for tech enthusisasts<span>"</span></p>
        </div>
    </section>
    ...
    <section class="mission">
        ...
        <div class="mission-quotes">
            <p id="mission-quotes">To make professional education accesssible and affordable for all</p>
            <p id="mission-quotes2">Empower aspiring developers and tech professionals with practical and interactive education online</p>
        </div>
    </section>
