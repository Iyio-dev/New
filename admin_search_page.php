    ...
    <section class="playlists">
        ...
        <div class="box-container">
            ...
            ?>
                        <div class="box">
                            <div class="flex">
                                <div><i class="fas fa-circle-dot" style="color:<?php if ($fetch_playlist['status'] == 'active') {
                                                                                    echo 'limegreen';
                                                                                } else {
                                                                                    echo 'red';
                                                                                } ?>"></i><span style="color:<?php if ($fetch_playlist['status'] == 'active') {
                                                                                                                    echo 'limegreen';
                                                                                                                } else {
                                                                                                                    echo 'red';
                            ...
                            <form action="" class="flex-btn" method="post">
                                ...
                                <input type="submit" name="delete_playlist" value="delete" class='delete-btn' onclick="return confirm('are you sure you want to delete this playlist')">
                            </form>
