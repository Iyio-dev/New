...
if (isset($_POST['delete_playlist'])) {
    ...
    if ($verify_playlist->rowCount() > 0) {
        ...
        header('location:update_playlist.php');
    } else {
                ...
                <div class="row">
                    <div class="thumb">
                        ...
                        <div class="flex">
                            ...
                            <p><i class="fas fa-calender"></i><span><?= $fetch_playlist['date']; ?></span></p>
                        </div>
                    </div>
                    <div class="details">
                        ...
                        <form action="" class="flex-btn" method="post">
                            ...
                            <a type="sbmit" name="delete_playlist" value="delete" class='delete-btn' onclick="return confirm('are you sure you want to delete this playlist')">delete</a>
                        </form>
                    </div>
                </div>
    ...
    <section class="contents">
        ...
        <div class="box-container">
            ...
            ?>
                    <div class="box">
                        <div class="flex">
                            <p><i class="fas fa-circle-dot" style="color:<?php if ($fetch_content['status'] == 'active') {
                                                                                echo 'limegreen';
                                                                            } else {
                                                                                echo 'red';
                                                                            } ?>;"></i><span style="color:<?php if ($fetch_content['status'] == 'active') {
                                                                                                                                                                                            echo 'limegreen';
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo 'red';
                                                                                                                                                                                        } ?>;"><?= $fetch_content['status'] ?></span></p>
            ...
            <?php
                ...
                echo '<p class="empty">no contents added yet!<a href="add_content.php" class="btn" style="margin-top: 2rem;">Add a new content</a></p>';
            }
